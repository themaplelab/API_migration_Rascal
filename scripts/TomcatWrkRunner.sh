	...
	for PORT in 8085
		...
		do
			...
			then
				...
				cd /home/hewage/data/experiments/scripts
				taskset -c 16,17,20,21 ./wrk -t15000 -c15000 -d300s --timeout 300s http://localhost:$PORT/java-project/hello > /home/hewage/data/experiments/scripts/Data/tomcat/$1/warmup-$i-$PORT-1.txt &
				pid1=$!
				taskset -c 18,19,22,23 ./wrk -t15000 -c15000 -d300s --timeout 300s http://localhost:$PORT/java-project/hello > /home/hewage/data/experiments/scripts/Data/tomcat/$1/warmup-$i-$PORT-2.txt &
				pid2=$!
				taskset -c 48,49,52,53 ./wrk -t15000 -c15000 -d300s --timeout 300s http://localhost:$PORT/java-project/hello > /home/hewage/data/experiments/scripts/Data/tomcat/$1/warmup-$i-$PORT-3.txt &
                                pid3=$!
				taskset -c 50,51,54,55 ./wrk -t15000 -c15000 -d300s --timeout 300s http://localhost:$PORT/java-project/hello > /home/hewage/data/experiments/scripts/Data/tomcat/$1/warmup-$i-$PORT-4.txt &
                                pid4=$!
