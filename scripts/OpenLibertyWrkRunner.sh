...
do
	...
	do
		...
		then
			...
			cd /home/hewage/data/experiments/scenario_all_2024_02_01/wlp/bin
		fi
		killall -9 java
		...
		do
			...
			then 	
				...
				taskset -c 17-18 ./wrk -t25000 -c30000 -d180s --timeout 180s http://localhost:$PORT/hello > /home/hewage/data/experiments/scripts/Data/$1/output-$i-$PORT-1.txt 
				...
				cd /home/hewage/data/experiments/scripts
				taskset -c 17-18 ./wrk -t1500 -c2000 -d300s --timeout 300s http://localhost:$PORT/hello > /home/hewage/data/experiments/scripts/Data/$1/warmup-$i-$PORT-1.txt
				echo "Ending warmups ..."
				#sleep 60s
		...
		then 
			...
			cp -r /home/hewage/data/experiments/scenario_all_2024_02_01/wlp/usr/servers/test /home/hewage/data/experiments/scenario_all_2024_02_01/wlp/usr/servers/test2
			rm -r /home/hewage/data/experiments/scenario_all_2024_02_01/wlp/usr/servers/test
			mv /home/hewage/data/experiments/scenario_all_2024_02_01/wlp/usr/servers/test2 /home/hewage/data/experiments/scenario_all_2024_02_01/wlp/usr/servers/test
			kill $(lsof -t -i:9092)
			kill $(lsof -t -i:9442)
		fi
	done
