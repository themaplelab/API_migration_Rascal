...
def readFile(n, fileName):
    file1 = open("/home/data/experiments/scripts/Data/wildfly/" + n + "/" + fileName, "r+")
    return file1.read()


def writeFile(n, data):
    file1 = open("/home/data/experiments/scripts/Data/wildfly/" + n + "/transformed_final_output_" + n +".csv", "w+")
