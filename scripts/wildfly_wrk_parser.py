...
def readFile(n, fileName):
    file1 = open("/home/hewage/data/experiments/scripts/Data/wildfly/" + n + "/" + fileName, "r+")
    return file1.read()


def writeFile(n, data):
    file1 = open("/home/hewage/data/experiments/scripts/Data/wildfly/" + n + "/transformed_final_output_" + n +".csv", "w+")
...
def main(n):
    ...
    for i in range(1, 21):
        retval = {}
        for j in range(1,11):
            wrk_output = readFile(n,"output-" + str(i) + "-2-" + str(j) + ".txt")
